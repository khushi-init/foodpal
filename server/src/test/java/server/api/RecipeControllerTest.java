...
public class RecipeControllerTest {
    ...
    public void setUp(){
        ...
        sut = new RecipeController(mockRecipeRepository, mockIngredientRepository);
    ...
    public void getAllRecipesTest(){
        ...
        when(mockRecipeRepository.findAll()).thenReturn(expectedList);
    ...
    public void getByIdCorrectTest() {
        ...
        when(mockRecipeRepository.findById(id)).thenReturn(Optional.of(testRecipe));
    ...
    public void getByIdNotFoundTest() {
        ...
        when(mockRecipeRepository.findById(fakeId)).thenReturn(Optional.empty());
        ...
        verify(mockRecipeRepository, times(1)).findById(fakeId);
    }
    ...
    public void downloadRecipeFoundTest() {
        ...
        when(mockRecipeRepository.findById(id)).thenReturn(Optional.of(recipe));
    ...
    public void createRecipeCorrectTest() {
        ...
        when(mockRecipeRepository.save(inputRecipe)).thenReturn(savedRecipe);
        ...
        verify(mockRecipeRepository, times(1)).save(inputRecipe);
    }
    ...
    public void createRecipeBadRequestTest() {
        ...
        verify(mockRecipeRepository, never()).save(badRecipe);
    }
    ...
    public void deleteRecipeNotFoundTest() {
        ...
        when(mockRecipeRepository.existsById(fakeId)).thenReturn(false);
        ...
        verify(mockRecipeRepository, never()).deleteById(fakeId);
    }
